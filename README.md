...
- features a tiny ~15mb docker from scratch container for only the minimum needed (python3, picows, pygames-chat all compiled into a single static executable binary)
