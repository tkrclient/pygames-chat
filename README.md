...
- features a tiny ~13mb docker from scratch container 😎, for only the minimum needed (python3, picows, websocket.py all compiled into a single static executable binary) (no init system, no kernel, no linux distro, just the app itself)
